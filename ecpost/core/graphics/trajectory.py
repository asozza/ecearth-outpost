...
"""
Graphics for Phase-space trajectory
...
from ecpost.core.means.means import movave, spacemean
...
def plot_trajectory(expname, startyear, endyear, varname1, varname2, 
